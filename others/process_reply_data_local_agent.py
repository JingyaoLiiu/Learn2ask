...
for instance in dataset:
    ...
    agent_reply = instance["generated_text"][0].replace("<|im_end|>", "").strip()
    if SNOWBALL:
        user_2 = second_round_prompt.replace("[ANSWER]", agent_reply).replace("[QUESTION]", instance["modified"])
    else:
        user_2 = second_round_prompt.replace("[ANSWER]", agent_reply)
