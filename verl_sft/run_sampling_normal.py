...
OUTPUT_PATH = "/public/home/ldk/users/ljy/learn2ask/verl_sft/data/Llama-3.1-8B-Instruct_train_3k_rollout_normal.jsonl"
...
def process_sample(instance):
    ...
    for i in range(4):
        ...
        try:
            messages = [{"role": "user", "content": init_prompt.replace("[Question]", question)}]
