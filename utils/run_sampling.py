...
DATA_PATH = "train_both.jsonl"
OUTPUT_PATH = "train_qwen3-14b_rollouts.jsonl"
...
def process_sample(instance):
    ...
    origin = instance["extra_info"]["origin"]
    modified = instance["extra_info"]["modified"]
    ref = instance["extra_info"]["answer"].split("####")[1].strip()
