...
for instance in dataset:
    instance["query"] = tokenizer.apply_chat_template(conversation=[{"role": "user", "content": prompt.replace("[QUESTION]", instance["origin"].replace("[", "").replace("]", ""))},], tokenize=False, add_generation_prompt=True, enable_thinking=ENABLE_THINKING)
